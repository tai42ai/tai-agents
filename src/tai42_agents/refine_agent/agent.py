...
token (:data:`~tai42_agents.refine_agent.prompt.CRITIC_APPROVAL_MESSAGE`) or the
...
projected as the normalized :class:`~tai42_contract.agent.events.StreamEvent`
...
class RefineAgent(Agent):
    ...
    async def astream(
        ...
        **kwargs: Any,
        ...
        other :class:`~tai42_contract.agent.Agent.run` parameter has no seat in the
        ...
        surfaced as a terminal :class:`~tai42_contract.agent.events.StructuredFinal`;
