...
from tai_agents._internal.config_util import build_run_config
...
@tai_app.agents.agent("tools_agent")
class ToolsAgent(Agent):
    ...
    async def run(
        ...
        **_: Any,
        ...
        resolved_tools = await resolve_tools(tai_app.tools, list(tool_names), list(tools), list(presets or []))
    ...
    async def astream(
        ...
        **_: Any,
        ...
        :func:`~tai_agents._internal.config_util.build_run_config` helper — so a
